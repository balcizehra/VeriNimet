...
// (Pazartesi/Pazar) ve dönem/hafta numaralarını döner. Etiket geçersizse null döner —
// bu yüzden "geçerli bir hafta mı?" sorusunun tek kaynağı budur (bkz. gecerliHaftaMi).
...
// Bir hafta etiketinin ("D01H0004" gibi) gerçekten geçerli formatta olup
// olmadığını söyler. Veritabanında elle girilmiş / bozuk bir değer varsa
// (örn. eski format ya da hatalı kayıt) bu false döner — dropdown'lar ve
// grafikler bu fonksiyonla filtreleme yapar.
export function gecerliHaftaMi(h) {
  return haftaDetay(h) !== null;
}
